...
function(r, e, t, n, i, o, a, s) {
    ...
    }), localStorage.setItem("abtesting.ai-uuid", o)), a = d("abtestingai_ab_test_id"), s = d("utm_term") || d("hsa_kw") || d("keyword"), scripts.push("https://0qc70jhcz7.execute-api.eu-west-2.amazonaws.com/variant/get-variant/?width=" + i + "&url=" + encodeURIComponent(window.location.href) + "&referrer=" + encodeURIComponent(document.referrer) + "&uuid=" + encodeURIComponent(o) + "&ab_test_id=" + (a ? encodeURIComponent(a) : "") + "&utm_term=" + (s ? encodeURIComponent(s) : "") + "&url_params=" + encodeURIComponent(location.search)), function(e, t, n, i, o) {
        function a(e) {
